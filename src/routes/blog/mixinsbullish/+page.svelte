...
<p>
  ...
  <code>@mixin</code>
  from the <a href="https://drafts.csswg.org/css-mixins-1/">Functions and Mixins Module</a> has
  quickly become one of my favorite parts of CSS. Even though I have to
  <a href="https://www.npmjs.com/package/vite-plugin-functions-mixins">polyfill it</a>, mixins solve
  so many of the problems with classes+variables:
</p>
<ul>
  <li>
    Classes make a non-Tailwind project feel like Tailwind. Mixins go with the rest of your styles,
    upholding separation of concerns.
  </li>
  <li>
  ...
  <li>
    You can't customize with pure classes because their styles are sometimes inlined, so you have to
